...
def train_and_test(nb_epochs, weight, method, degree, random_seed):
    ...
    with sv.managed_session() as sess:
        ...
        for t in range(nr_batches_train_org):
            ...
            feed_dict = {input_pl: trainx_org[ran_from:ran_to],
        ...
        precision, recall, f1,_ = precision_recall_fscore_support(trainy_org,
                                                                  y_pred_org,
                                                                  average='binary')
        ...
        save_results(scores, trainy_org, 'bigan', 'sia_train_air_4', 'fm', '0.5', '1', 2018, 'outlier', 0.1, step=-1)
        ...
        TN_train, FN_train, FP_train, TP_train = my_confusion_matrix(trainy_org, y_pred_org)
        ...
        save_results(scores, testy, 'bigan', 'sia_test_air_4', 'fm', '0.5', '1', 2018, 'outlier', 0.1, step=-1)
